          ...
          Flexible(
            child: Container(
              ...
              decoration: BoxDecoration(
                color: isDark ? AppTheme.userBubbleDark : const Color(0xFFE9ECEF),
                  ...
                  if (msg.attachmentName != null) ...[
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          const Icon(Icons.attach_file, size: 14, color: AppTheme.brandAccent),
                ...
                if (msg.thoughtProcess != null && msg.thoughtProcess!.isNotEmpty) ...[
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            _showThoughts ? 'Hide Reasoning' : 'View Agent Reasoning',
                            style: TextStyle(
                              fontSize: 11.5,
                          ...
                          const SizedBox(width: 4),
                          Icon(
                            _showThoughts ? Icons.keyboard_arrow_up : Icons.keyboard_arrow_down,
                            size: 14,
                            color: isDark ? AppTheme.darkTextSecondary : Colors.black54,
                          ),
                        ],
                  ...
                  if (_showThoughts)
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: isDark ? const Color(0xFF1E1E1E) : const Color(0xFFE9ECEF),
                        borderRadius: BorderRadius.circular(8),
                        border: Border.all(color: isDark ? AppTheme.darkBorder : const Color(0xFFD1D5DB)),
                      ),
